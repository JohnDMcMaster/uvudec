...
UVDJavascriptSpidermonkeyInterpreter::UVDJavascriptSpidermonkeyInterpreter()
{
}
...
uv_err_t UVDJavascriptSpidermonkeyInterpreter::init()
{
...
uv_err_t UVDJavascriptSpidermonkeyInterpreter::interpret(const UVDInterpreterExpression &exp, const UVDVariableMap &environment, std::string &sRet)
{
	/*
