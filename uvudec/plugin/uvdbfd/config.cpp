...
uv_err_t UVDBFDConfig::init(UVDConfig *config)
{
	uv_assert_err_ret(g_bfdPlugin->registerArgument(UVDBFD_ARCHITECTURE_HINT, 0, "bfd-arch", "architecture hint", 1, argParser, true));
